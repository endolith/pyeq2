...
class AphidPopulationGrowth(pyeq2.Model_2D_BaseClass.Model_2D_BaseClass):
    ...
    def SpecificCodeCPP(self):
        return "\ttemp = a * exp(b * x_in) * pow(1.0 + c * exp(b * x_in), -2.0);\n"
...
class BertalanffyGrowth(pyeq2.Model_2D_BaseClass.Model_2D_BaseClass):
    ...
    def SpecificCodeCPP(self):
        return "\ttemp = Linf * (1.0 - exp(-1.0 * K * (x_in - tzero)));\n"
...
class BevertonHoltA(pyeq2.Model_2D_BaseClass.Model_2D_BaseClass):
    ...
    def SpecificCodeCPP(self):
        return "\ttemp = r / (1.0 + ((r - 1.0) / K) * x_in);\n"
...
class BevertonHoltB(pyeq2.Model_2D_BaseClass.Model_2D_BaseClass):
    ...
    def SpecificCodeCPP(self):
        return "\ttemp = x_in * r / (1.0 + ((r - 1.0) / K) * x_in);\n"
...
class BioScienceA(pyeq2.Model_2D_BaseClass.Model_2D_BaseClass):
    ...
    def SpecificCodeCPP(self):
        return "\ttemp = a * (1.0 - (b * pow(c, x_in)));\n"
...
class BioScienceB(pyeq2.Model_2D_BaseClass.Model_2D_BaseClass):
    ...
    def SpecificCodeCPP(self):
        return "\ttemp = a * (1.0 - pow(1.0 + pow(x_in / b, c), -1.0 * d));\n"
...
'''
    ...
    def SpecificCodeCPP(self):
        return '\ttemp = p3/(1.0 + exp((x_in-p1)/p2)) + p4*exp((x_in-45.0)/p5);\n'
...
class DerekDuncanCustomEquation(pyeq2.Model_2D_BaseClass.Model_2D_BaseClass):
    ...
    def SpecificCodeCPP(self):
        return "\ttemp = a / pow(1 + exp(-1/b*(x_in-c)), d);\n"
...
class DoseResponseA(pyeq2.Model_2D_BaseClass.Model_2D_BaseClass):
    ...
    def SpecificCodeCPP(self):
        return "\ttemp = b + (a-b) / (1.0 + pow(10.0, x_in - c))\n"
...
class DoseResponseB(pyeq2.Model_2D_BaseClass.Model_2D_BaseClass):
    ...
    def SpecificCodeCPP(self):
        return "\ttemp = b + (a-b) / (1.0 + pow(10.0, c - x_in))\n"
...
class DoseResponseC(pyeq2.Model_2D_BaseClass.Model_2D_BaseClass):
    ...
    def SpecificCodeCPP(self):
        return "\ttemp = b + (a-b) / (1.0 + pow(10.0, d * (x_in - c)))\n"
...
class DoseResponseD(pyeq2.Model_2D_BaseClass.Model_2D_BaseClass):
    ...
    def SpecificCodeCPP(self):
        return "\ttemp = b + (a-b) / (1.0 + pow(10.0, d * (c - x_in)))\n"
...
class DoseResponseE(pyeq2.Model_2D_BaseClass.Model_2D_BaseClass):
    ...
    def SpecificCodeCPP(self):
        return "\ttemp = b + (a-b) / (1.0 + pow(x_in / c, d))\n"
...
class GeneralizedNegativeExponential(pyeq2.Model_2D_BaseClass.Model_2D_BaseClass):
    ...
    def SpecificCodeCPP(self):
        return "\ttemp = a * pow(1.0 - exp(-1.0 * b * x_in), c);\n"
...
class GeneralizedProductAccumulation(pyeq2.Model_2D_BaseClass.Model_2D_BaseClass):
    ...
    def SpecificCodeCPP(self):
        return "\ttemp = a * (b - x_in) / (c + (b - x_in)) + d * (b - x_in) + f;\n"
...
class GeneralizedSubstrateDepletion(pyeq2.Model_2D_BaseClass.Model_2D_BaseClass):
    ...
    def SpecificCodeCPP(self):
        return "\ttemp = (a * x_in) / (b + x_in) - (c * x_in) - d;\n"
...
class HighLowAffinity(pyeq2.Model_2D_BaseClass.Model_2D_BaseClass):
    ...
    def SpecificCodeCPP(self):
        return "\ttemp = (a * b *x_in) / (1.0 + b * x_in);\n"
...
class HighLowAffinityDouble(pyeq2.Model_2D_BaseClass.Model_2D_BaseClass):
    ...
    def SpecificCodeCPP(self):
        return "\ttemp = (a * b * x_in) / (1.0 + b * x_in) + (c * d * x_in) / (1.0 + d * x_in);\n"
...
class HighLowAffinityIsotopeDisplacementDouble(pyeq2.Model_2D_BaseClass.Model_2D_BaseClass):
    ...
    def SpecificCodeCPP(self):
        return "\ttemp = (a * b) / (1.0 + b * x_in) + (c * d) / (1.0 + d * x_in);\n"
...
class HyperbolicF(pyeq2.Model_2D_BaseClass.Model_2D_BaseClass):
    ...
    def SpecificCodeCPP(self):
        return "\ttemp = a * x_in / (b + x_in) + c * x_in;\n"
...
class HyperbolicG(pyeq2.Model_2D_BaseClass.Model_2D_BaseClass):
    ...
    def SpecificCodeCPP(self):
        return "\ttemp = a * x_in / (b + x_in) + c * x_in / (d + x_in);\n"
...
class HyperbolicH(pyeq2.Model_2D_BaseClass.Model_2D_BaseClass):
    ...
    def SpecificCodeCPP(self):
        return "\ttemp = a * x_in / (b + x_in) + c * x_in / (d + x_in) + f * x_in;\n"
...
class HyperbolicLogistic(pyeq2.Model_2D_BaseClass.Model_2D_BaseClass):
    ...
    def SpecificCodeCPP(self):
        return "\ttemp = (a * pow(x_in, b)) / (c + pow(x_in, b));\n"
...
class MembraneTransport(pyeq2.Model_2D_BaseClass.Model_2D_BaseClass):
    ...
    def SpecificCodeCPP(self):
        return "\ttemp = a * (x_in - b) / (x_in * x_in + c * x_in + d);\n"
...
class NegativeExponential(pyeq2.Model_2D_BaseClass.Model_2D_BaseClass):
    ...
    def SpecificCodeCPP(self):
        return "\ttemp = a * (1.0 - exp(-1.0 * b * x_in));\n"
...
class NewZealandEcologyLogistic1(pyeq2.Model_2D_BaseClass.Model_2D_BaseClass):
    ...
    def SpecificCodeCPP(self):
        return "\ttemp = B0 + ((B1 - B0) / (1.0 + exp((B2 + x_in) * B3)));\n"
...
class NewZealandEcologyLogistic2(pyeq2.Model_2D_BaseClass.Model_2D_BaseClass):
    ...
    def SpecificCodeCPP(self):
        return "\ttemp = B0 + ((B1 - B0) / (1.0 + exp((B2 + x_in + (B4 * x_in * x_in)) * B3)));\n"
...
'''
    ...
    def SpecificCodeCPP(self):
        return "\ttemp = exp(log(y0) * exp(-1.0 * r * x_in));\n"
...
'''
    ...
    def SpecificCodeCPP(self):
        return "\ttemp = 1.0 / (1.0 + (1.0 - y0) / (y0 * exp(-1.0 * r * x_in)));\n"
...
'''
    ...
    def SpecificCodeCPP(self):
        return "\ttemp = 1.0 - ((1.0 - y0) * exp(-1.0 * r * x_in));\n"
...
'''
    ...
    def SpecificCodeCPP(self):
        return "\ttemp = 1.0 - exp(-1.0 * pow((x_in - a) / b, c));\n"
...
class PlantDisease_WeibullScaled(pyeq2.Model_2D_BaseClass.Model_2D_BaseClass):
    ...
    def SpecificCodeCPP(self):
        return "\ttemp = Scale * (1.0 - exp(-1.0 * pow((x_in - a) / b, c)));\n"
...
class PreeceAndBaines(pyeq2.Model_2D_BaseClass.Model_2D_BaseClass):
    ...
    def SpecificCodeCPP(self):
        return "\ttemp = a - 2.0 * (a-b) / (exp(c*(x_in - d)) + exp(f*(x_in - d)));\n"
...
class StandardLogistic5Parameter(pyeq2.Model_2D_BaseClass.Model_2D_BaseClass):
    ...
    def SpecificCodeCPP(self):
        return "\ttemp = d + (a - d) / pow(1.0 + pow(x_in / c, b), f);\n"
...
class StandardLogistic4Parameter(pyeq2.Model_2D_BaseClass.Model_2D_BaseClass):
    ...
    def SpecificCodeCPP(self):
        return "\ttemp = d + (a - d) / (1.0 + pow(x_in / c, b));\n"
...
class Weibull(pyeq2.Model_2D_BaseClass.Model_2D_BaseClass):
    ...
    def SpecificCodeCPP(self):
        return "\ttemp = a * (1.0 - exp(-1.0 * b * pow(x_in - c, d)));\n"
...
class XiaogangPengImmunoassay(pyeq2.Model_2D_BaseClass.Model_2D_BaseClass):
    ...
    def SpecificCodeCPP(self):
        return "\ttemp = K / (1.0 + exp(-1.0 * (a + b * log(x_in) + c * x_in)));\n"
