...
for modelsTypeName in ['Models_2D', 'Models_3D']:
    modelsFile = open(f"{modelsTypeName}.js", 'wt')
    exec(f'models = pyeq2.{modelsTypeName}')
                                                    ...
                                                    (
                                                        (
                                                            (
                                                                (
                                                                    (
                                                                        f'exports.{moduleName}.{className} = module.exports.{moduleName}.{className}'
                                                                        + ''' = {
    pythonModuleName : "'''
                                                                    )
                                                                    + moduleName
    ...
    numberOfParameters : '''
                                ...
                                + str(
                                    len(
                                        equationInstance.GetCoefficientDesignators()
                                    )
                                )
                                + '''
};
